...
def upgrade() -> None:
    ...
    property_category = sa.Enum('BEACH', 'MOUNTAIN', 'JUNGLE', 'CITY', 'RURAL', 'LAKE', name='propertycategory')
    property_category.create(op.get_bind(), checkfirst=True)
    
    # Properties columns
    op.add_column('properties', sa.Column('short_description', sa.String(length=500), nullable=True))
    ...
    op.add_column('properties', sa.Column('map_address', sa.String(length=500), nullable=True))
    ...
    op.add_column('properties', sa.Column('currency', sa.String(length=3), nullable=True))
    ...
    op.add_column('properties', sa.Column('seo_title', sa.String(length=255), nullable=True))
    ...
    op.add_column('properties', sa.Column('seo_slug', sa.String(length=255), nullable=True))
    ...
    # Rooms columns
    op.add_column('rooms', sa.Column('slug', sa.String(length=255), nullable=False, server_default=''))
