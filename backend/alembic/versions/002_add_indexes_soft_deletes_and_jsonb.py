...
def upgrade() -> None:
    ...
    # User indexes
    op.create_index(
        "idx_user_role_active", "users", ["role", "is_active", "deleted_at"]
    )
    ...
    op.create_index(
        "idx_property_featured",
        "properties",
        ["is_featured", "is_active", "deleted_at"],
    )
    ...
    # Tour indexes
    op.create_index(
        "idx_tour_featured", "tours", ["is_featured", "is_active", "deleted_at"]
    )
    ...
    op.create_index(
        "idx_blog_featured", "blog_posts", ["is_featured", "status", "deleted_at"]
    )
    ...
    op.create_index(
        "idx_vehicle_available", "vehicles", ["is_available", "is_active", "deleted_at"]
    )
    ...
    op.create_index(
        "idx_boat_available", "boats", ["is_available", "is_active", "deleted_at"]
    )
    ...
    op.create_index(
        "idx_flight_route", "flights", ["origin_airport", "destination_airport"]
    )
    ...
    # Pricing indexes
    op.create_index(
        "idx_pricing_service", "pricing_rules", ["service_type", "service_id"]
    )
