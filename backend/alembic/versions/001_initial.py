...
def upgrade() -> None:
    ...
    op.create_table('users',
        ...
        sa.Column('role', sa.Enum('SUPER_ADMIN', 'VENDOR', 'CLIENT', name='userrole'), nullable=False),
    ...
    op.create_table('properties',
        ...
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('property_type', sa.Enum('HOTEL', 'HOSTEL', 'ECO_LODGE', 'RESORT', 'VILLA', 'APARTMENT', 'CABIN', 'GLAMPING', name='propertytype'), nullable=False),
    ...
    op.create_table('tours',
        ...
        sa.Column('slug', sa.String(length=255), nullable=False),
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('category', sa.Enum('ADVENTURE', 'NATURE', 'CULTURAL', 'WATER', 'WELLNESS', 'GASTRONOMY', name='tourcategory'), nullable=False),
        sa.Column('difficulty', sa.Enum('EASY', 'MODERATE', 'CHALLENGING', name='tourdifficulty'), nullable=True),
        ...
        sa.Column('not_included', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    op.create_index('idx_booking_confirmation', 'bookings', ['confirmation_code'], unique=True)
    ...
    op.create_table('destinations',
        ...
        sa.Column('things_to_do', postgresql.JSON(astext_type=sa.Text()), nullable=True),
