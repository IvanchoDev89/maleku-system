...
async def create_vehicle(
    ...
    allowed_fields = ['vehicle_type', 'brand', 'model', 'year', 'color', 'license_plate',
                     'capacity', 'transmission', 'fuel_type', 'features', 'daily_rate',
                     'weekly_rate', 'monthly_rate', 'security_deposit', 'description',
                     'photos', 'is_insured', 'insurance_details', 'requirements']
    vehicle_data_filtered = {k: v for k, v in vehicle_data.model_dump().items() if k in allowed_fields}
...
async def update_vehicle(
    ...
    allowed_fields = {'vehicle_type', 'brand', 'model', 'year', 'color', 'license_plate',
                     'capacity', 'transmission', 'fuel_type', 'features', 'daily_rate',
                     'weekly_rate', 'monthly_rate', 'security_deposit', 'description',
                     'photos', 'is_insured', 'insurance_details', 'requirements', 'is_active'}
