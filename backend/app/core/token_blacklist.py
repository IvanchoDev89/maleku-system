...
class TokenBlacklist:
        ...
        try:
            ...
            if ttl > 0:
                ...
                await self.redis_client.setex(
                    f"blacklist:token:{token_hash}", ttl, "revoked"
                )
    ...
    async def blacklist_user_tokens(
        self, user_id: str, expire_all_after: datetime
    ) -> bool:
        """
    ...
    async def is_user_tokens_blacklisted(
        self, user_id: str, token_issued_at: datetime
    ) -> bool:
        """
