...
class CloudinaryService:
    ...
    def __init__(self):
        ...
        if not CLOUDINARY_AVAILABLE:
            logger.warning("Cloudinary not installed. Image uploads will be unavailable.")
            return
    ...
    async def upload_image(
        ...
        except (cloudinary.exceptions.Error, cloudinary.exceptions.ApiError, ValueError) as e:
