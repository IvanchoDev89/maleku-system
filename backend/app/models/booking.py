...
from sqlalchemy import Column, String, DateTime, ForeignKey, Text, Integer, Enum, Index, Numeric
...
class Booking(Base):
    ...
    tour_id = Column(UUID(as_uuid=True), ForeignKey("tours.id", ondelete="SET NULL"), nullable=True)
    ...
    __table_args__ = (
        ...
        Index('idx_booking_availability', 'property_id', 'room_id', 'check_in', 'check_out', 
