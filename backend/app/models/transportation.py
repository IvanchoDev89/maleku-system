...
from sqlalchemy import Column, String, Boolean, DateTime, ForeignKey, Float, Integer, JSON, Enum, Index, Numeric
...
class Transportation(Base):
    ...
    service_type = Column(Enum(TransportServiceType), default=TransportServiceType.AIRPORT_TRANSFER, nullable=False)
    vehicle_type = Column(Enum(TransportVehicleType), default=TransportVehicleType.SEDAN, nullable=False)
    ...
    pricing_type = Column(Enum(PricingType), default=PricingType.PER_ROUTE, nullable=False)
