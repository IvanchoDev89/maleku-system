<template>
  <div>
    <div class="flex justify-between items-center mb-8">
      ...
      <NuxtLink to="/vendor/tours/new" class="bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary-700">
        + Nuevo Tour
      </NuxtLink>
    </div>
        ...
        <table class="w-full">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th class="text-left py-3 px-4 font-semibold text-gray-600 hidden sm:table-cell">Categoría</th>
              <th class="text-left py-3 px-4 font-semibold text-gray-600 hidden md:table-cell">Duración</th>
