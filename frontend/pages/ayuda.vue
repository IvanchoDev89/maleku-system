<template>
  <div class="min-h-screen bg-gray-50 py-12">
    <div class="container mx-auto px-4 max-w-4xl">
      <h1 class="text-3xl font-bold mb-8">Centro de Ayuda</h1>
      <div class="space-y-4">
...
<script setup>
useSeo({
  title: 'Centro de Ayuda | Costa Rica Travel',
  description: 'Encuentra respuestas a preguntas frecuentes sobre reservas, pagos, cancelaciones y más.'
})
