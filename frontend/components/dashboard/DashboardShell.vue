...
const vendorTitles: Record<string, string> = {
  ...
  '/vendor/vehicles': 'Vehículos',
  '/vendor/boats': 'Embarcaciones',
  '/vendor/transportation': 'Transporte',
...
const managementMenuItems = computed(() =>
  isAdmin.value
    ...
    : [
        ...
        { icon: 'lucide:car', label: 'Vehículos', path: '/vendor/vehicles' },
        { icon: 'lucide:ship', label: 'Embarcaciones', path: '/vendor/boats' },
        { icon: 'lucide:bus', label: 'Transporte', path: '/vendor/transportation' },
