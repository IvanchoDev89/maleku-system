...
import {
  Search, MapPin, Building2, Compass, FileText, Globe, ChevronDown,
  LogIn, LogOut, UserPlus, LayoutDashboard, Menu, X, Palmtree, Sun, Moon,
...
function closeLangMenu(event: MouseEvent) {
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          <ClientOnly>
            ...
            <template #fallback>
              <div class="p-2.5 bg-white/10 rounded-lg"><div class="w-5 h-5"></div></div>
            </template>
          </ClientOnly>
